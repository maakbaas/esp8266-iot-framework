...
# change to 1 to enable reading of certificates on each build
if 0:
    ...
    try:
        ...
        for i in range(0, len(pems)):
            ...
            # Maakbaas: Added windows path
            ssl = Popen(['C:\\msys32\\usr\\bin\\openssl','x509','-inform','PEM','-outform','DER','-out', certName], shell = False, stdin = PIPE)
            pipe = ssl.stdin
        ...
        # Maakbaas: Added windows path
        arCmd = ['C:\\msys32\\usr\\bin\\ar', 'q', 'data/certs.ar'] + derFiles;
        call( arCmd )
        ...
        print("Updating certificates failed. Check the paths to openssl and ar!")

#
#
#
# Additional line to parse HTML file to PROGMEM
#
#
#
